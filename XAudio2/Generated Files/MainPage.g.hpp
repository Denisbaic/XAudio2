...
void ::XAudio2::MainPage::InitializeComponent()
{
    if (_contentLoaded)
    {
        return;
...
void ::XAudio2::MainPage::Connect(int __connectionId, ::Platform::Object^ __target)
{
    switch (__connectionId)
    {
    case 2:
        {
            this->errorText = safe_cast<::Windows::UI::Xaml::Controls::TextBlock^>(__target);
        }
        break;
    case 3:
        {
...
::Windows::UI::Xaml::Markup::IComponentConnector^ ::XAudio2::MainPage::GetBindingConnector(int __connectionId, ::Platform::Object^ __target)
{
